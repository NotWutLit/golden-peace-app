    ...
    <ModalComponentUser onClose={onClose} visible={visible} height="43%">
      ...
      >
        <View className="flex-row gap-4 items-center justify-between">
          <AntDesign name="user" size={24} color="#919EAB" />
          <View>
            <Text className="text-white">{user?.data?.fullName || 'Chris Hemsworth'}</Text>
            <Text className="text-[#919EAB]">{user?.data?.email || 'test@gmail.com'}</Text>
          </View>
        </View>
      ...
      >
        <View className="flex-row gap-4 items-center justify-between">
          <AntDesign name="setting" size={24} color="#919EAB" />
          <Text className="text-[#919EAB]">Cài đặt</Text>
        </View>
        <SimpleLineIcons name="arrow-right" size={16} color="#919EAB" />
      </TouchableOpacity>
      <TouchableOpacity
      ...
      >
        <View className="flex-row gap-4 items-center justify-between">
          <Entypo name="light-bulb" size={24} color="#919EAB" />
          <Text className="text-[#919EAB]">Giới thiệu</Text>
        </View>
        <SimpleLineIcons name="arrow-right" size={16} color="#919EAB" />
      </TouchableOpacity>
      <View className="w-full border border-dashed my-6" style={{ borderColor: '#919EAB' }} />
      <View className="flex-row justify-between w-full p-2 rounded-2xl items-center mb-6">
        <View className="flex-row gap-4 items-center justify-between">
          <Ionicons name="notifications-outline" size={24} color="#919EAB" />
          <Text className="text-[#919EAB]">Thông báo</Text>
        </View>
        <Switch
          value={checked}
      ...
      >
        <View className="flex-row gap-4 items-center justify-between">
          <AntDesign name="logout" size={24} color="#919EAB" />
          <Text className="text-[#919EAB]">Đăng xuất</Text>
        </View>
      </TouchableOpacity>
    </ModalComponentUser>
  )
