    ...
    <ImageBackground source={images.bgAuth} resizeMode="cover" className="h-full">
      ...
      <View className="justify-center mt-10 p-6 rounded-xl pt-48 pb-12">
        ...
        <TouchableOpacity className="flex-row gap-3 items-center justify-center mt-10 mb-6">
          <IconUploadImage />
          <View>
            <Text className="text-primary">Tối thiểu 300x300px</Text>
            <Text className="text-disabled">JPG hoặc PNG. Tối đa 2MB.</Text>
          </View>
        </TouchableOpacity>
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <View>
              <Text className="text-primary my-2 ml-2">Tên của bạn</Text>
              <TextInput
        ...
        <TouchableOpacity
          ...
          disabled={updateProfileMutation.isPending}
        >
          <Text className="text-primary font-semibold text-sm">Bỏ qua</Text>
        </TouchableOpacity>
      </View>
    </ImageBackground>
  )
